...
const translations = {
  ...
  zh: {
    ...
    aboutTitle: "關於Cwrite",
    aboutText1: "一個為高年級小學生設計嘅AI驅動平台。",
    aboutText2: "結合人工智能同自主學習原則。",
    aboutText3: "創造個人化、互動嘅寫作體驗。",
    enhanceTitle: "我哋如何增強創意寫作",
    visionTitle: "我哋嘅願景",
    visionText: "重塑數碼時代嘅創意寫作教育。成為創意寫作教育嘅全球創新者。培養下一代創意領袖。",
    startButton: "開始制定計劃",
    question: "AI點樣可以令創意寫作對ESL學習者更有吸引力，同時保持原創性？",
    storyTitle: "故事寫作",
